...
// INPUT PARAMS
function length() = 84;
function endHeight() = 60;
function endDepth() = 30;

function shelfHeightsAndAngles() = [[0,15],[15,15],[30,15],[45,0]];

function endStockWidth() = 5;
function endStockThickness() = 1.9;

function slatStockWidth() = 1.9;
function slatStockThickness() = 1;

function minSlatSpacing() = 1.9;
function maxSlats() = 6;

function raisedFrontSlatMinAngle() = 5;

function reduceUniqueParts() = false;
